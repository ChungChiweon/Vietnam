...
export function mapProductRow(row: ProductRow): Product {
  ...
  return {
    ...
    ingredientTags: stringArray(row.ingredient_tags),
    benefitTags: stringArray(row.benefit_tags),
    skinConcernTags: stringArray(row.skin_concern_tags),
    skinTypeTags: stringArray(row.skin_type_tags),
    inciIngredients: stringArray(row.inci_ingredients),
    normalizedIngredients: stringArray(row.normalized_ingredients),
    cautionTags: stringArray(row.caution_tags),
    derivedBenefitTags: stringArray(row.derived_benefit_tags),
